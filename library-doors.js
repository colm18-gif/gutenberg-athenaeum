...
(function(){
  ...
  window.createDoorKit=function({THREE,MAT,canvasTexture}){
    ...
    function build(parent,{style='walnut',width=2.2,height=3.6,label='',glow=true,fanlight=true}={}){
      ...
      const beyond=add(group,new THREE.PlaneGeometry(width,height),mat.beyond,0,height/2,-.06);
      ...
      const door={group,pivot,leaf,hits,fan,spill,open:0,target:0,onOpened:null,swing:style==='iron'?-1.25:-1.45};
