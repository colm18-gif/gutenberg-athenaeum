(function(){
  ...
  window.createHighStaircase=function(options){
    ...
    const stepPath=[],topBooks=[],moonBooks=[],animatedLights=[];let rocketTrip=null,lastSpaceTone=-30,hallStarField=null;
